...
import { MdOutlineExplore, MdOutlineInsertChartOutlined } from "react-icons/md";
...
export default function Sidebar() {
  ...
  return (
    <div className="w-full sticky top-9">
      <span className="hidden xl:block text-[26px] font-normal font-[Lobster] text-[#262626] px-3 pt-[25px] pb-[16px] mb-8">
        Instagram
      </span>
      <span className="block xl:hidden flex justify-center">
        <svg
          ...
          {menuItems.map(({ href, label, icon }) => {
            ...
            return (
              ...
              >
                <Link
                  href={href}
                  className={`w-full flex gap-3 p-3 rounded cursor-pointer
                ...
                >
                  {label === "نمایه" ? (
                    ...
                    icon && <span className="w-7 h-7 text-black">{icon}</span>
                  )}
